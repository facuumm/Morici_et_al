...
%             else
                ...
                % CAMBIAR NOMBRES AZUL
                save([cd,'\dorsalventral_XXXXXXXX.mat'],'Th' , 'pat' , 'eig' , 'criteria_fr' , 'criteria_n')
%             end
...
%             else
                ...
                % CAMBIAR NOMBRES AZUL
                save([cd,'\dorsalventral8xxxxxxx.mat'],'Th' , 'pat' , 'eig' , 'criteria_fr' , 'criteria_n')
%             end
