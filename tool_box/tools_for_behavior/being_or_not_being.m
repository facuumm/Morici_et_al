...
%
% speed: structure, contains average speed before the first shock and
%        before the same moment in the reward session.
%
% metrics_before_shock: structure, it stores the counts of laps before the
%                       first shock and same moment in the reward session.
%
