...
%                 m3 = mean(movmean(tmp(InIntervals(bins,NREM_A))./binSize,freq));
                m4 = length(Restrict(spks,NREM))/sum(NREM(:,2)-NREM(:,1));
                m4 = mean(movmean(tmp(InIntervals(bins,NREM))./binSize,freq));
...
%                 m7 = mean(movmean(tmp(InIntervals(bins,REM_A))./binSize,freq));
                m8 = length(Restrict(spks,REM))/sum(REM(:,2)-REM(:,1));
                m8 = mean(movmean(tmp(InIntervals(bins,REM))./binSize,freq));
...
%             end
        ...
        if and(and(~isempty(NREM_A),~isempty(NREM_R)),~isempty(NREM_B))
            if aversiveTS_run(1)>rewardTS_run(1)
                % dHPC
                if not(isempty(spiketrains_dHPC_pyr))
                ...
                % vHPC
                if not(isempty(spiketrains_vHPC_pyr))
                ...
                % dHPC - vHPC
                if and(not(isempty(spiketrains_vHPC_pyr)) , not(isempty(spiketrains_dHPC_pyr)))
                    x = [spiketrains_dHPC_pyr(is.baseline.sws,:)];
                    y = [spiketrains_vHPC_pyr(is.baseline.sws,:)];
                    if and(size(y,2) > 1 , size(x,2) > 1)
                        [S1 , p]=corr(x,y);
                        %                 imagesc([1:size(x,2)], [1:size(y,1)], S1),caxis([0 1]),
                        clear x y p
...
figure,
subplot(221),
scatter(FR_dHPC_int(:,12),FR_dHPC_int(:,1),2,'filled','MarkerFaceColor',[0.6 0.0 0.6]),hold on
scatter(FR_dHPC_pyr(:,12),FR_dHPC_pyr(:,1),2,'filled','MarkerFaceColor',[0.1986 0.7214 0.6310])
...
subplot(222),
scatter(FR_dHPC_int(:,12),FR_dHPC_int(:,5),2,'filled','MarkerFaceColor',[0.6 0.0 0.6]),hold on
scatter(FR_dHPC_pyr(:,12),FR_dHPC_pyr(:,5),2,'filled','MarkerFaceColor',[0.1986 0.7214 0.6310])
set(gca,'xscale','log','yscale','log'),xlim([0.001 100]),ylim([0.001 100]),
...
subplot(223),
scatter(FR_vHPC_int(:,12),FR_vHPC_int(:,1),2,'filled','MarkerFaceColor',[0.6 0.0 0.6]),hold on
scatter(FR_vHPC_pyr(:,12),FR_vHPC_pyr(:,1),2,'filled','MarkerFaceColor',[0.1986 0.7214 0.6310])
set(gca,'xscale','log','yscale','log'),xlim([0.001 100]),ylim([0.001 100]),
plot(x,y),ylabel('NREM rate (HZ)') , xlabel('WAKE rate (Hz)')
title('vHPC pyr + int')

subplot(224),
scatter(FR_vHPC_int(:,12),FR_vHPC_int(:,5),2,'filled','MarkerFaceColor',[0.6 0.0 0.6]),hold on
scatter(FR_vHPC_pyr(:,12),FR_vHPC_pyr(:,5),2,'filled','MarkerFaceColor',[0.1986 0.7214 0.6310])
set(gca,'xscale','log','yscale','log'),xlim([0.001 100]),ylim([0.001 100]),
plot(x,y),ylabel('REM rate (HZ)') , xlabel('WAKE rate (Hz)')
title('vHPC pyr + int')
...
% Just aversive conditions
figure,
subplot(221),
scatter(FR_dHPC_int(:,11),FR_dHPC_int(:,4),2,'filled','MarkerFaceColor',[0.6 0.0 0.6]),hold on
scatter(FR_dHPC_pyr(:,11),FR_dHPC_pyr(:,4),2,'filled','MarkerFaceColor',[0.1986 0.7214 0.6310]),hold on
set(gca,'xscale','log','yscale','log'),xlim([0.001 100]),ylim([0.001 100]),
x = linspace(0.001,100);
y = linspace(0.001,100);
plot(x,y),ylabel('NREM rate (HZ)') , xlabel('WAKE rate (Hz)')
...
subplot(222),
scatter(FR_dHPC_int(:,11),FR_dHPC_int(:,4),2,'filled','MarkerFaceColor',[0.6 0.0 0.6]),hold on
scatter(FR_dHPC_pyr(:,11),FR_dHPC_pyr(:,4),2,'filled','MarkerFaceColor',[0.1986 0.7214 0.6310])
set(gca,'xscale','log','yscale','log'),xlim([0.001 100]),ylim([0.001 100]),
plot(x,y),ylabel('REM rate (HZ)') , xlabel('WAKE rate (Hz)')
title('dHPC pyr + int')
...
subplot(223),
scatter(FR_vHPC_int(:,11),FR_vHPC_int(:,4),2,'filled','MarkerFaceColor',[0.6 0.0 0.6]),hold on
scatter(FR_vHPC_pyr(:,11),FR_vHPC_pyr(:,4),2,'filled','MarkerFaceColor',[0.1986 0.7214 0.6310])
set(gca,'xscale','log','yscale','log'),xlim([0.001 100]),ylim([0.001 100]),
plot(x,y),ylabel('NREM rate (HZ)') , xlabel('WAKE rate (Hz)')
title('vHPC pyr + int')
...
% Just reward conditions
figure,
subplot(221),
scatter(FR_dHPC_pyr(:,10),FR_dHPC_pyr(:,3),2,'filled','MarkerFaceColor',[0.1986 0.7214 0.6310]),hold on
scatter(FR_dHPC_int(:,12),FR_dHPC_int(:,1),2,'filled','MarkerFaceColor',[0.6 0.0 0.6])
set(gca,'xscale','log','yscale','log'),xlim([0.001 100]),ylim([0.001 100]),
x = linspace(0.001,100);
y = linspace(0.001,100);
plot(x,y),ylabel('NREM rate (HZ)') , xlabel('WAKE rate (Hz)')
...
subplot(222),
scatter(FR_dHPC_pyr(:,10),FR_dHPC_pyr(:,3),2,'filled','MarkerFaceColor',[0.1986 0.7214 0.6310]),hold on
scatter(FR_dHPC_int(:,12),FR_dHPC_int(:,5),2,'filled','MarkerFaceColor',[0.6 0.0 0.6])
set(gca,'xscale','log','yscale','log'),xlim([0.001 100]),ylim([0.001 100]),
plot(x,y),ylabel('REM rate (HZ)') , xlabel('WAKE rate (Hz)')
title('dHPC pyr + int')
...
subplot(223),
scatter(FR_vHPC_pyr(:,10),FR_vHPC_pyr(:,3),2,'filled','MarkerFaceColor',[0.1986 0.7214 0.6310]),hold on
scatter(FR_vHPC_int(:,12),FR_vHPC_int(:,1),2,'filled','MarkerFaceColor',[0.6 0.0 0.6])
set(gca,'xscale','log','yscale','log'),xlim([0.001 100]),ylim([0.001 100]),
plot(x,y),ylabel('NREM rate (HZ)') , xlabel('WAKE rate (Hz)')
title('vHPC pyr + int')
...
subplot(224),
scatter(FR_vHPC_pyr(:,10),FR_vHPC_pyr(:,3),2,'filled','MarkerFaceColor',[0.1986 0.7214 0.6310]),hold on
scatter(FR_vHPC_int(:,12),FR_vHPC_int(:,5),2,'filled','MarkerFaceColor',[0.6 0.0 0.6])
set(gca,'xscale','log','yscale','log'),xlim([0.001 100]),ylim([0.001 100]),
plot(x,y),ylabel('REM rate (HZ)') , xlabel('WAKE rate (Hz)')
title('vHPC pyr + int')
...
figure,
subplot(221)
histogram(ratio.NREM.dHPC.pyr,20,'FaceColor',[0.1986 0.7214 0.6310],'EdgeColor','none','FaceAlpha',0.5),hold on
% xline(nanmedian(ratio.NREM.dHPC.pyr),'Color',[0.1986 0.7214 0.6310],'LineWidth',1)
p = signrank(ratio.NREM.dHPC.pyr)
xline(nanmedian(ratio.NREM.dHPC.pyr),'Color',[0.1986 0.7214 0.6310],'LineWidth',1)

histogram(ratio.NREM.dHPC.int,20,'FaceColor',[0.6 0.0 0.6],'EdgeColor','none','FaceAlpha',0.5),ylim([0 120]),xlim([-1 1])
% xline(nanmedian(ratio.NREM.dHPC.int),'Color',[0.6 0.0 0.6],'LineWidth',1)
p = signrank(ratio.NREM.dHPC.int)
xline(nanmedian(ratio.NREM.dHPC.int),'Color',[0.6 0.0 0.6],'LineWidth',1)

subplot(222)
histogram(ratio.REM.dHPC.pyr,20,'FaceColor',[0.1986 0.7214 0.6310],'EdgeColor','none','FaceAlpha',0.5),hold on
% xline(nanmedian(ratio.REM.dHPC.pyr),'Color',[0.1986 0.7214 0.6310],'LineWidth',1)
p = signrank(ratio.REM.dHPC.pyr)
xline(nanmedian(ratio.REM.dHPC.pyr),'Color',[0.1986 0.7214 0.6310],'LineWidth',1)

histogram(ratio.REM.dHPC.int,20,'FaceColor',[0.6 0.0 0.6],'EdgeColor','none','FaceAlpha',0.5),ylim([0 120]),xlim([-1 1])
% xline(nanmedian(ratio.REM.dHPC.int),'Color',[0.6 0.0 0.6],'LineWidth',1)
p = signrank(ratio.REM.dHPC.int)
xline(nanmedian(ratio.REM.dHPC.int),'Color',[0.6 0.0 0.6],'LineWidth',1)

subplot(223)
histogram(ratio.NREM.vHPC.pyr,20,'FaceColor',[0.1986 0.7214 0.6310],'EdgeColor','none','FaceAlpha',0.5),hold on
% xline(nanmedian(ratio.NREM.vHPC.pyr),'Color',[0.1986 0.7214 0.6310],'LineWidth',1)
p = signrank(ratio.NREM.vHPC.pyr)
xline(nanmedian(ratio.NREM.vHPC.pyr),'Color',[0.1986 0.7214 0.6310],'LineWidth',1)

histogram(ratio.NREM.vHPC.int,20,'FaceColor',[0.6 0.0 0.6],'EdgeColor','none','FaceAlpha',0.5),ylim([0 80]),xlim([-1 1])
% xline(nanmedian(ratio.NREM.vHPC.int),'Color',[0.6 0.0 0.6],'LineWidth',1)
p = signrank(ratio.NREM.vHPC.int)
xline(nanmedian(ratio.NREM.vHPC.int),'Color',[0.6 0.0 0.6],'LineWidth',1)

subplot(224)
histogram(ratio.REM.vHPC.pyr,20,'FaceColor',[0.1986 0.7214 0.6310],'EdgeColor','none','FaceAlpha',0.5),hold on
% xline(nanmedian(ratio.REM.vHPC.pyr),'Color',[0.1986 0.7214 0.6310],'LineWidth',1)
p = signrank(ratio.REM.vHPC.pyr)
xline(nanmedian(ratio.REM.vHPC.pyr),'Color',[0.1986 0.7214 0.6310],'LineWidth',1)

histogram(ratio.REM.vHPC.int,20,'FaceColor',[0.6 0.0 0.6],'EdgeColor','none','FaceAlpha',0.5),ylim([0 80]),xlim([-1 1])
% xline(nanmedian(ratio.REM.vHPC.int),'Color',[0.6 0.0 0.6],'LineWidth',1)
p = signrank(ratio.REM.vHPC.int)
xline(nanmedian(ratio.REM.vHPC.int),'Color',[0.6 0.0 0.6],'LineWidth',1)
