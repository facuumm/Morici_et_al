...
%% Main Loop: stability across time controling for nlaps in ave/rew 
% Stability parameters 
tresh_lap_ave = 15;
tresh_lap_rew = 15; 
template_laps = 5; %# of laps to contruct the tempalte and compare stability. 
...
figure(2);clf; hold on
% histogram(vstab_ave,100,'EdgeColor',[0 0 0],'FaceColor','r'); hold on
% histogram(vstab_rew,100,'EdgeColor',[0 0 0],'FaceColor','b'); hold on
