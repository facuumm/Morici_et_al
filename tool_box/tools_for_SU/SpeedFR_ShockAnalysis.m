        ...
        if exist('dHPC_responsivness_all.mat')
            ...
            if size(clu,1)>=1
                ...
                for i=1:size(clu,1)
                    ...
                    dHPC.shock = [dHPC.shock ; f.Rsquared.Ordinary coefTest(f) resp s]; clear m mm resp s
                end
            end
        end
        ...
        if exist('vHPC_responsivness_all.mat')
            ...
            if size(clu,1)>=1
                ...
                for i=1:size(clu,1)
                    ...
                    f = fitlm(meanSpeed,(spiketrain));
                    vHPC.shock = [vHPC.shock ; f.Rsquared.Ordinary coefTest(f) resp s]; clear m mm resp s
