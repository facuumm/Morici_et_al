...
for tt = 1:length(path)
    ...
    for t = 1 : length(subFolders)-2
        ...
        Response.speed.id = [Response.speed.id ; tt t length(Shocks_filt)];
        ...
        if or(numberD >3 , numberV > 3)
            ...
            if sum(cond.both.aversive)>0
                [curve , time , responsive] = Assemblies_responsivness_fixed(patterns.all.aversive , cond.both.aversive , [bins' , Spikes] , Shocks_filt , [0 1] ,10 , 0.1 , 0 ,'zscore' , 2);
            ...
            if sum(cond.both.reward)>0
                [curve , time , responsive] = Assemblies_responsivness_fixed(patterns.all.reward , cond.both.reward , [bins' , Spikes] , Shocks_filt , [0 1] ,10 , 0.1 , 0 ,'zscore' , 2);
            ...
            if sum(cond.dHPC.aversive)>0
                [curve , time , responsive] = Assemblies_responsivness_fixed(patterns.all.aversive , cond.dHPC.aversive , [bins' , Spikes] , Shocks_filt , [0 1] ,10 , 0.1 , 0 ,'zscore' , 2);
            ...
            if sum(cond.dHPC.reward)>0
                [curve , time , responsive] = Assemblies_responsivness_fixed(patterns.all.reward , cond.dHPC.reward , [bins' , Spikes] , Shocks_filt , [0 1] ,10 , 0.1 , 0 ,'zscore' , 2);
            ...
            if sum(cond.vHPC.aversive)>0
                [curve , time , responsive] = Assemblies_responsivness_fixed(patterns.all.aversive , cond.vHPC.aversive , [bins' , Spikes] , Shocks_filt , [0 1] ,10 , 0.1 , 0 ,'zscore' , 2);
            ...
            if sum(cond.vHPC.reward)>0
                [curve , time , responsive] = Assemblies_responsivness_fixed(patterns.all.reward , cond.vHPC.reward , [bins' , Spikes] , Shocks_filt , [0 1] ,10 , 0.1 , 0 ,'zscore' , 2);
